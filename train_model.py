...
def train_model(model, train_dataloader, val_dataloader, optimizer, criterion, num_epochs, patience, seed=None):
    ...
    # Riinizializza le liste dei dati dei grafici all'inizio di ogni chiamata
    epoch_train_loss = []
    epoch_train_accuracy = []
    epoch_val_loss = []
    epoch_val_accuracy = []
